...
public class GetEncounterUseCase {
    ...
    public Optional<ClinicalEncounter> execute(TenantSlug tenantSlug, UUID encounterId, ServiceScope scope) {
        return repository.findById(tenantSlug, encounterId, scope);
    }
}
